...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__team_team__ = __webpack_require__(194);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\Niklas Schuster\Documents\GitHub\clubcorner_frontend\clubcorner\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Handballverein XY</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n    <ion-list>\n        <button [navPush]="teamPage" ion-item *ngFor="let item of items">\n          {{item.title}}\n        </button> \n        <ion-item>\n            <ion-input type="text" placeholder="Beitrittscode eingeben"></ion-input>\n            <button ion-button outline item-end icon-left color="dark">\n              <ion-icon name="md-add-circle"></ion-icon>\n              Beitreten\n            </button>\n          </ion-item>\n      </ion-list>\n\n      \n\n\n\n  <ion-fab left bottom>\n      <button ion-fab color="dark"><ion-icon name="arrow-dropup"></ion-icon></button>\n      <ion-fab-list side="top">\n        <button ion-button round small color="dark" style="float:left;">Spieler einladen</button>\n        <button ion-button round small color="dark" style="float:left;">Spielerliste</button>\n        <button ion-button round small color="dark" style="float:left;">Training planen</button>\n        <button ion-button round small color="dark" style="float:left;">Spiel anlegen</button>\n        <button ion-button round small color="dark" style="float:left;">Mannschaft auflösen</button>\n      </ion-fab-list>\n    </ion-fab> \n\n\n</ion-content>\n<ion-footer>\n  <ion-toolbar>\n      <button ion-button item-end icon-left block round small color="secondary">\n          <ion-icon name="md-add-circle"></ion-icon>\n          Mannschaft anlegen\n        </button>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"C:\Users\Niklas Schuster\Documents\GitHub\clubcorner_frontend\clubcorner\src\pages\home\home.html"*/
        }),
...
var TeamPage = /** @class */ (function () {
    ...
    TeamPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-team',template:/*ion-inline-start:"C:\Users\Niklas Schuster\Documents\GitHub\clubcorner_frontend\clubcorner\src\pages\team\team.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Mannschaft 1</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content  class="card-background-page">\n\n    <ion-list>\n\n\n        <ion-card *ngFor="let item of items">\n          <img src="https://images.unsplash.com/photo-1480099225005-2513c8947aec?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=2dab7651bd475cd91549954a03180cdb&auto=format&fit=crop&w=1465&q=80"/>\n          <div class="myOverlay">\n          <div class="card-title">Training</div>\n          <div class="card-subtitle">Dienstag 25.05.2018 16:00 Uhr</div>\n          \n             \n          \n          <div class="card-button">\n            <button ion-button icon-left color="secondary" outline>\n                <ion-icon name="checkmark-circle"></ion-icon>\n                Zusagen\n              </button>\n              <button ion-button icon-left color="danger" outline>\n                  <ion-icon name="close-circle"></ion-icon>\n                  Absagen\n                </button>\n          </div>\n        </div>\n        </ion-card>\n      </ion-list>\n\n      \n\n\n\n  <ion-fab left bottom>\n      <button ion-fab color="secondary"><ion-icon name="arrow-dropup"></ion-icon></button>\n      <ion-fab-list side="top">\n        <button ion-button round small color="light" style="float:left;">Spieler einladen</button>\n        <button ion-button round small color="light" style="float:left;">Spielerliste</button>\n        <button ion-button round small color="light" style="float:left;">Training planen</button>\n        <button ion-button round small color="light" style="float:left;">Spiel anlegen</button>\n        <button ion-button round small color="light" style="float:left;">Mannschaft auflösen</button>\n      </ion-fab-list>\n    </ion-fab> \n\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\Niklas Schuster\Documents\GitHub\clubcorner_frontend\clubcorner\src\pages\team\team.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
    ], TeamPage);
    return TeamPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_team_team__ = __webpack_require__(194);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__pages_team_team__["a" /* TeamPage */]
            ],
            imports: [
